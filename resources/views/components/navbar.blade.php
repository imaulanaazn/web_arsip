<nav
    ...
    <div class="navbar-nav-right d-flex align-items-center justify-content-between" id="navbar-collapse">
        ...
        <div class="d-flex align-items-center gap-3">
            <form action="{{ url()->current() }}">
                <div class="navbar-nav align-items-center">
                    <div class="nav-item d-flex align-items-center bg-light rounded border">
                        <input
                            type="text"
                            name="search"
                            value="{{ $search ?? '' }}"
                            ...
                            placeholder="{{ __('navbar.search') }}"
                            aria-label="{{ __('navbar.search') }}" />
                        <button type="submit" class="pt-1 pb-1 border-0" style="background: transparent; padding-right: .8rem;"><i class="bx bx-search fs-4 lh-0"></i></button>
                    </div>
                </div>
            </form>
